...
const Tailoring = () => {
  ...
  useEffect(() => {
    ...
    // Hardcoded list of tailoring shops in Tirupati, Andhra Pradesh
    const tirupatiTailoringShops = [
      { id: 'shop1', name: 'Sri Venkateswara Tailors', address: 'Near RTC Bus Stand, Tirupati, AP - 517501', distance: '0.5km' },
      { id: 'shop2', name: 'Balaji Mens Tailoring', address: 'Tilak Road, Tirupati, AP - 517507', distance: '1.2km' },
      { id: 'shop3', name: 'Lakshmi Tailoring Shop', address: 'Karakaambedu Road, Tirupati, AP - 517520', distance: '2.0km' },
      { id: 'shop4', name: 'New Style Tailors', address: 'Prakasam Road, Tirupati, AP - 517501', distance: '0.8km' },
      { id: 'shop5', name: 'Srinivasa Tailoring', address: 'Balaji Colony, Tirupati, AP - 517502', distance: '1.5km' },
    ];
    setShops(tirupatiTailoringShops);
  }, [isAuthenticated]);
